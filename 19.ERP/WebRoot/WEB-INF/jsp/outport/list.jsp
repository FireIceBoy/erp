...
<body>
    ...
    <div class="tools">
        <div align="center">
          <form id="for">
	        <ul class="seachform1">
			    <li><input name="keywords" id="keywords" value="${outportVo.keywords }" type="text" class="scinput1" placeholder="供应商/操作员/商品名称" /></li>
			    <li>
			    	<div class="vocation" align="left">
			    	<input name="begintime" id="beginTime" value="${outportVo.begintime }" type="text" class="scinput1" placeholder="起始时间"/>
			    	</div>
			    </li>
			    <li><input name="endtime" id="endTime" value="${outportVo.endtime }" type="text" class="scinput1" placeholder="截止时间" /></li>
        	...
        	<c:otherwise>
        		<c:forEach items="${list }" var="sn">
        			 <tr>
				        ...
				        <td>${sn.comment }</td>
				        <td>
				        	<a href="outport_del.action?id=${sn.id }" class="tablelink"> 删除</a>
				        </td>
			        </tr> 
        		</c:forEach>
        	</c:otherwise>
   ...
   <div class="pagin">
    ...
    <script type="text/javascript">
		...
		function changePage(currentPage) {
	        ...
	        window.location.href="outport_query.action?pageBean.currentPage="+currentPage+"&keywords="+keywords+"&beginTime="+beginTime+"&endTime="+endTime;
	    }

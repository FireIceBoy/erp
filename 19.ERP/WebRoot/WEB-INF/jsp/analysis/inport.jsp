   ...
   <div class="formbody">
    ...
    <script type="text/javascript">
	    ...
	    $("#gid").change(function(){
	    	...
	    	var arr = [];
			var gid = $(this).val();
			$.post("goodsName_queryInport.action",{'goodsVo.gid': gid},function(list){
				listInports = list.listInports;
				for(var i =0; i<listInports.length; i++){
					var inporttime = listInports[i].inporttime.substring(0,10)
					num[i]=listInports[i].number;
					arr[i]=inporttime;
				}

...
<body>
    ...
    <div class="tools">
    	<ul class="toolbar">
	      <a href="provider_toAdd.action">  <li class="click"><span><img src="images/t01.png" /></span>添加</li></a>
        </ul>
        <div align="center">
          <form id="for">
	        <ul class="seachform1">
			    <li><input name="providername" id="providername" value="${providerVo.providername }" type="text" class="scinput1" placeholder="按供应商名称查找" /></li>
			    <li><input name="keywords" id="keywords" value="${providerVo.keywords }" type="text" class="scinput1" placeholder="按联系人或电话查找" /></li>
			    <li>
        	...
        	<c:otherwise>
        		<c:forEach items="${list }" var="sn">
        			 <tr>
				        ...
				        <td><a href="provider_toUpdate.action?pid=${sn.pid }" class="tablelink">修改</a>
				        	<a href="provider_del.action?pid=${sn.pid }" class="tablelink"> 删除</a></td>
			        </tr> 
        		</c:forEach>
        	</c:otherwise>
        </c:choose>
    ...
    <script type="text/javascript">
		...
		function changePage(currentPage) {
	        ...
	        window.location.href="provider_query.action?pageBean.currentPage="+currentPage+"&providername="+providername+"&keywords="+keywords+"&available="+available;
	    };
	</script>
